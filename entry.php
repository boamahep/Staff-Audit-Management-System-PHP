...
var name = document.entryLogin.user1.value;
var pass = document.entryLogin.pass1.value
...
<div class="add-container">
  ...
  <div class="add-user-main-panel">
    <form id="form2" name="entryLogin" method="post" action="pages/login.php" onsubmit="return validateForm();">
      <label></label>
      <label></label>
      ...
      <table width="315" align="center">
        ...
        <tr>
          <td>Username:</td>
          <td width="195"><input type="text" name="user1" tabindex="2" /></td>
        </tr>
        <tr>
          <td >Password:</td>
          <td width="195"><input type="password" name="pass1" tabindex="2" />
              <br />
        ...
        <tr>
          <td>&nbsp;</td>
          <td><a href="forget_pass_index1.php" class="style1"> Forget Password?</a> </td>
        </tr>
        <tr>
          <td>&nbsp;</td>
