...
<div class="add-container">
  ...
  <div class="add-user-menus-panel">
      ...
      <table width="669" align="center">
        ...
        <tr>
          <td width="417"><a href="logout.php?action=logged%out"><button>LogOut</button></a> &nbsp;
	 	...
	 	<?php
			...
			if(!$qry){echo mysql_error();}else{
				...
				echo '<tr>
						...
						<td>
							<a href="view_index.php?viewid='.$id.'"><img src="../assets/images/view.png" title="View More"></a>
                            
                            <a href="update_index.php?updateid='.$id.'"><img src="../assets/images/edit.png" title="Update"></a>

							<a href="delete_index.php?id='.$id.'"><img src="../assets/images/close.png" title="Delete"></a>
                            
                            <a><img src="../assets/images/'.$verification.'" title="status"></a>
