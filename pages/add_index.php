...
<div class="add-container">
  ...
  <div class="add-user-menus-panel">
      ...
      <table width="669" align="center">
        ...
        <tr>
          <td width="417"><a href="Main_index1.php"><button>Staff list</button></a>&nbsp;
 ...
 <div class="add-user-main-panel">
 	<form enctype="multipart/form-data" name="newStaffForm" action="add_code.php" method="POST">
...
<hr />
	 <table width="669" align="center">
	 	...
	 	<tr>
	        ...
	        <input name="fname" type="text" id="label" size="10" /></td>
...
<hr />
		...
		<tr>
          ...
          <input name="dob" type="text" id="textfield" size="20" /></td>
	      <td width="276"><label for="label5">Year of Service</label>
          <input type="text" name="year_of_service" id="label5" /></td>
		</tr>
...
<hr />
	 <table width="669" align="center">
		<tr>
	      ...
	      <input type="text" name="service_start_date" id="label6" /></td>
...
<hr />
	  <table width="669" align="center">
		<tr>
	      ...
	      <input name="cert" type="text" id="label9" size="70" />	</td>
	    </tr>
	 </table>
<hr />
	 <table width="669" align="center">
		...
		<tr>
	      ...
	      <input name="salary" type="text" id="label10" size="15" /></td>
		  <td width="185"><label for="label11">Allowance</label><br />
	      <input name="allowance" type="text" id="label11" size="15" /></td>
	      <td width="279"><label for="label12">Extimated arrear of salary</label><br />
          <input type="text" name="ext_ao_slr" id="label12" /></td>
		</tr>
	 </table>
<hr />
	 <table width="669" align="center">
		<tr>
	      ...
	      <input type="text" name="ext_ao_pension" id="label13" /></td>
		  <td width="218"><label for="label14">Extimated arrear of Tax</label><br />
	      <input type="text" name="ext_ao_tax" id="label14" /></td>
	      <td width="191"><label for="label15">Extimated arrear of other</label><br />
          <input type="text" name="ext_ao_other" id="label15" /></td>
		</tr>
	 </table>
<hr />
	  <table width="669" align="center">
